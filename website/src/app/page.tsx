  ...
  return (
    <div className="container mx-auto flex flex-col items-center px-4 py-24 text-center sm:py-32">
      ...
      <h1 className="max-w-3xl text-4xl font-bold tracking-tight sm:text-5xl">
        Coordinate a team of AI coding agents from one prompt.
      </h1>

      <p className="mt-6 max-w-2xl text-lg text-muted-foreground">
        <span className="font-semibold text-foreground">team-harness</span> is a
        coordinator LLM that breaks your task into work units and delegates them to
        real agent CLIs — Codex, Gemini, Claude Code, Antigravity, OpenCode, pi, and
        OpenHands — running as subprocesses. Plug in any model, tweak the prompts,
        and let the workers collaborate as a team.
      </p>
      ...
      <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row">
        ...
        <a
          href="https://github.com/writeitai/team-harness"
          target="_blank"
          rel="noreferrer"
