...
- **Real CLIs, not reimplementations.** Workers are the actual `codex`, `gemini`, `claude`, `grok`, and `agy` binaries as subprocesses — you get their real capabilities, sandboxes, and session handling.
